...
<div class="feature-image-side">
    <div class="content-wrapper">
        <div class="content">
            <h1 class="section-title page-title"><?php echo get_the_title(); ?></h1>
            <?php echo get_the_content(); ?>
            <div id="events">
                <div class="events-status">
                    <div class="events-category">
                        <h3 class="category-name">SIP Events (<?php echo count($sips); ?>)</h3>
                        <p>
